        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl shadow-xl p-6">
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="type" className="block text-sm font-medium text-gray-700 mb-2">Amount (฿)</label>
                <select
                  name="type"
                  value={type}
              ...
              </div>
              {
                type === '01' ? (
                  ...
                  <div>
                    <label htmlFor="promptPayId" className="block text-sm font-medium text-gray-700 mb-2">ID Card / Promppay ID</label>
                    <input
                      type="text"
                      name="promptPayId"
                      value={promptPayId}
